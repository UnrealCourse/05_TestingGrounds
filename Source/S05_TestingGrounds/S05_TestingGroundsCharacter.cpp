...
void AS05_TestingGroundsCharacter::SetupPlayerInputComponent(class UInputComponent* InputComponent)
{
	...
	{
		InputComponent->BindAction("Fire", IE_Pressed, this, &AS05_TestingGroundsCharacter::OnFire);
	}

	InputComponent->BindAxis("MoveForward", this, &AS05_TestingGroundsCharacter::MoveForward);
	InputComponent->BindAxis("MoveRight", this, &AS05_TestingGroundsCharacter::MoveRight);
...
bool AS05_TestingGroundsCharacter::EnableTouchscreenMovement(class UInputComponent* InputComponent)
{
	bool bResult = false;
	if (FPlatformMisc::GetUseVirtualJoysticks() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		bResult = true;
		InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AS05_TestingGroundsCharacter::BeginTouch);
		InputComponent->BindTouch(EInputEvent::IE_Released, this, &AS05_TestingGroundsCharacter::EndTouch);
		InputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AS05_TestingGroundsCharacter::TouchUpdate);
	}
	return bResult;
}
